/// score_multiplier(effect, x, y)
 ...
 // Add to multiplier.
    if(global.cscore_mtp != 16)
    {
       global.cscore_mtp += 1;
    }
    
 // Return score.
    if(global.cscore_mtp == 1)
    {
       if(argument0 == true)
       { 
          var _score;
    ...
    if(global.cscore_mtp > 3 && global.cscore_mtp < 16)
    {
       if(argument0 == true)
       { 
          var _score;
